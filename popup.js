  ...
  fetch('https://estensione-chrome.fly.dev/politica')
    ...
    .then(data => {
      ...
      const news = articles.map(article => {
        ...
        if (article.querySelector('._taxonomy-item__time_al3wh_37.col-lg-1.col-sm-12').textContent.includes('ore') || article.querySelector('._taxonomy-item__time_al3wh_37.col-lg-1.col-sm-12').textContent.includes('ora')) {
          publicationDate.setDate(today.getDate());
        } else {
